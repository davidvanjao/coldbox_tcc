...
module.exports = {
    async listar(request, response) {
        try {
            // instruções SQL
            const sql = `select nivel_id, nivel_acesso, nivel_descricao from novo_nivel_acesso;`; 
    ...
    async editar(request, response) {
        try {
            ...
            // instruções SQL
            const sql = `UPDATE novo_nivel_acesso SET nivel_acesso = ?, nivel_descricao = ? WHERE nivel_id = ?;`; 
    ...
    async apagar(request, response) {
        try {
            ...
            // comando de exclusão
            const sql = `DELETE FROM novo_nivel_acesso WHERE nivel_id = ?;`;

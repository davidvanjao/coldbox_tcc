    ...
    return (
        <div className="paginaSuporte"> 
            <div className="containerSuporte">
                <h1>Suporte ColdBox</h1>
                <p>Bem-vindo à Central de Suporte da ColdBox!</p>
                <p>
                ...
                <p>ColdBox - Tecnologia em Monitoramento de Câmaras Frias para um Controle Total e Seguro.</p>
            </div>
        </div>
    );
};
